...
export const JobApplications: CollectionConfig = {
  slug: 'job-applications', admin: { group: 'Contact', useAsTitle: 'name' },
  access: {
  ...
  fields: [
    ...
    { name: 'vacancyTitle', type: 'text', required: true, admin: { description: 'Snapshot of the vacancy title at submission time.' } },
    ...
    { name: 'status', type: 'select', required: true, defaultValue: 'new',
      options: [{ label: 'New', value: 'new' }, { label: 'In Review', value: 'in-review' }, { label: 'Closed', value: 'closed' }],
